...
class ChannelEffMISSFormer(nn.Module):
    def __init__(self, num_classes=9, head_count=1, token_mlp_mode="mix_skip"):
        super().__init__()
    
        # Encoder
        dims, key_dim, value_dim, layers = [[320, 512], [320, 512], [320, 512], [2, 2, 2]]        
        ...
        in_out_chan = [[32, 64, 64],[128, 128, 160],[320, 320, 256],[512, 512, 512]]  # [dim, out_dim, key_dim, value_dim, x2_dim]

...
parser.add_argument("--model_name", type=str, default="transfilm", help="model_name")
...
parser.add_argument(
    "--module", help="The module that you want to load as the network, e.g. networks.EfficientFormer.EffFormer"
)

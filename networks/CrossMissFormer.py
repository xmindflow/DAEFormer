    ...
    def __init__(self, input_size, in_out_chan, heads, reduction_ratios, token_mlp_mode, n_class=9, norm_layer=nn.LayerNorm, is_last=False):
        ...
        if not is_last:
            ...
            self.cross_attn = CrossAttentionBlock(
                dims, key_dim, value_dim, input_size[0], input_size[1], heads, token_mlp_mode)
            ...
            self.x1_linear = nn.Linear(x1_dim, out_dim)
            self.cross_attn = CrossAttentionBlock(
                dims*2, key_dim, value_dim, input_size[0], input_size[1], heads, token_mlp_mode)
...
class CrossMISSFormer(nn.Module):
    def __init__(self, num_classes=9, token_mlp_mode="mix_skip", encoder_pretrained=True):
        ...
        in_out_chan = [[32, 64, 64, 64, 64], [128, 128, 128, 128, 160], [
            320, 320, 320, 320, 256], [512, 512, 512, 512, 512]]
    ...
    def forward(self, x):
        ...
        # ---------------Decoder-------------------------
        # print("stage3-----")
        tmp_3 = self.decoder_3(encoder[3].permute(0, 2, 3, 1).view(b, -1, c))
        # print("stage2-----")
        tmp_2 = self.decoder_2(tmp_3, encoder[2].permute(0, 2, 3, 1))
        # print("stage1-----")
        tmp_1 = self.decoder_1(tmp_2, encoder[1].permute(0, 2, 3, 1))
        # print("stage0-----")
        tmp_0 = self.decoder_0(tmp_1, encoder[0].permute(0, 2, 3, 1))

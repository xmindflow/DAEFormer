...
class MyDecoderLayer(nn.Module):
    ...
    def forward(self, x1, x2=None):
        if x2 is not None:# skip connection exist
            ...
            #     x1 = x1.view(b, -1, c)
            if self.last_layer:
                out = self.last_layer(self.layer_up(x1).view(b, 224, 224, -1).permute(0,3,1,2))
            else:
...
class ChannelEffFormer(nn.Module):
    def __init__(self, num_classes=9, head_count=1, token_mlp_mode="mix_skip"):
        ...
        in_out_chan = [[32, 64, 64, 64, 64],[128, 128, 128, 128, 160],[320, 256, 320, 320, 256],[512, 512, 512, 512, 512]]  # [dim, out_dim, key_dim, value_dim, x2_dim]
    ...
    def forward(self, x):
        ...
        tmp_2 = self.decoder_2(tmp_3)
        tmp_1 = self.decoder_1(tmp_2)
        tmp_0 = self.decoder_0(tmp_1)
